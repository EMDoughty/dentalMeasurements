...
#sources for Jon Marcot's code and specimen measurements 
 ...
 source("C:/Users/Woof/Documents/PPP_Pred_Prey Code/R/common_src/strat.R")
 source("C:/Users/Woof/Documents/PPP_Pred_Prey Code/R/common_src/occFns.R")
 source("C:/Users/Woof/Documents/PPP_Pred_Prey Code/R/common_src/sampling.R") 
 source("C:/Users/Woof/Documents/PPP_Pred_Prey Code/R/common_src/utils_marcot.R")
 source("C:/Users/Woof/Documents/PPP_Pred_Prey Code/R/common_src/CzTimescale.R") 
 
 source("C:/Users/Woof/Documents/PPP_Pred_Prey Code/R/DentalMeasurements/src/src_dentalDataFns.R", chdir = TRUE)
 source("C:/Users/Woof/Documents/PPP_Pred_Prey Code/R/DentalMeasurements/src/src_bodyMassEstimation.R", chdir = TRUE)
 source("C:/Users/Woof/Documents/PPP_Pred_Prey Code/R/DentalMeasurements/src/src_ecologyAnalysisFns.R", chdir = TRUE)
 
 source("C:/Users/Woof/Documents/PPP_Pred_Prey Code/R/Recreate Dental Plots Source 2021_6_2.R")
...
####################################################################################################################################
 ...
 # occs <- read.csv("http://paleobiodb.org/data1.2/occs/list.csv?base_name=Mammalia&continent=NOA&max_ma=66&min_ma=0&timerule=overlap&show=full&limit=all", stringsAsFactors=TRUE, strip.white=TRUE)
  occs <- read.csv("C:/Users/Woof/Documents/PPP_Pred_Prey Code/R/Occs_2021_9_5.csv")
...
if(run.taxon == "ungulates")
{
  ...
  archaic.ung <- read.csv("C:/Users/Woof/Documents/PPP_Pred_Prey Code/R/ArchaicUngulate_UploadFile_2021_4_29.csv")
...
{
  pred.data <- read.csv("C:/Users/Woof/Documents/PPP_Pred_Prey Code/R/Predator_data_all.csv")
...
save(repIntTaxa, optList_tax_median, optList_tax_allReps, 
     file=paste0("C:/Users/Woof/Documents/PPP_Pred_Prey Code/R/Results/Taxon_handleyResult_", run.taxon,
                 "_SampleStandardized=", do.subsample,"_Reps=",reps,".Rdata"))
...
save(repIntTaxa, optList_bm_median, optList_bm_allReps,
     file=paste0("C:/Users/Woof/Documents/PPP_Pred_Prey Code/R/Results/BM_handleyResult_", run.taxon,
                 "_SampleStandardized=", do.subsample,"_Reps=", reps,".Rdata"))
