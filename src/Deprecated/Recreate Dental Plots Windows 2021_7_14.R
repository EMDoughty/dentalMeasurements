...
source("C:/Users/Bark/Documents/PPP_Pred_Prey Code/R/common_src/strat.R")
source("C:/Users/Bark/Documents/PPP_Pred_Prey Code/R/common_src/occFns.R")
source("C:/Users/Bark/Documents/PPP_Pred_Prey Code/R/common_src/sampling.R") 
source("C:/Users/Bark/Documents/PPP_Pred_Prey Code/R/common_src/utils_marcot.R")
source("C:/Users/Bark/Documents/PPP_Pred_Prey Code/R/common_src/CzTimescale.R") 

source("C:/Users/Bark/Documents/PPP_Pred_Prey Code/R/DentalMeasurements/src/src_dentalDataFns.R", chdir = TRUE)
source("C:/Users/Bark/Documents/PPP_Pred_Prey Code/R/DentalMeasurements/src/src_bodyMassEstimation.R", chdir = TRUE)
source("C:/Users/Bark/Documents/PPP_Pred_Prey Code/R/DentalMeasurements/src/src_ecologyAnalysisFns.R", chdir = TRUE)

source("C:/Users/Bark/Documents/PPP_Pred_Prey Code/R/Recreate Dental Plots Source 2021_6_2.R")
...
archaic.ung <- read.csv("C:/Users/Bark/Documents/PPP_Pred_Prey Code/R/ArchaicUngulate_UploadFile_2021_4_29.csv")
...
load(file = "C:/Users/Bark/Documents/PPP_Pred_Prey Code/R/UngulateRepIntBackups_2021_7_12.RData")
...
###############################################################################################################
#run carnivore data
pred.data <- read.csv("C:/Users/Bark/Documents/PPP_Pred_Prey Code/R/Predator_data_all.csv")
...
focal.order <- c("Carnivora", "Creodonta","Hyaenodonta","NO_ORDER_SPECIFIED")
occs <- occs[occs$order %in% focal.order,]
focal.family <- unique(occs[occs$order %in% focal.order,]$family)
focal.family <- c(as.character(focal.family), "Viverravidae","Hyaenodontidae","NO_FAMILY_SPECIFIED")
...
shortFamPred <- sort(unique(bigListPred$family[bigListPred$family %in% focal.family]))	
...
#do hadley anaylsis on extended ungulate dataset
PredrepIntAll <- getRepIntData(measure.mat = pred.data,
                               col.nam = "BM_all_carnivoran",
                               int_length = 2,
                               occs = occs,
                               int_min = 1,
                               int_max = 64,
...
#need to finish transitioning these to pred data
shoulderPlot(measure.mat = pred.data, plot.y = "BM_all_carnivoran", occs = occs, this.rank = "species", 
...
#predator bm catagorization
#1 <1 kg
#2 1-7 kg
#3 7-21kg (seems to be less filled than 2 and 4 on Christiane plot.  Like there some species there but always less when community is more even distributed)
#4 21-100 kg (blaire might want this set to 200)
#5 100+ kg
bm_quantsPred_allcarniv <- getTraitQuants(measure.mat = pred.data, traitCol = "BM_all_carnivoran", repIntTaxa = PredrepIntAll$RepsTaxa)
bm_quantsPred_extantreg <- getTraitQuants(measure.mat = pred.data, traitCol = "BM_extant_reg", repIntTaxa = PredrepIntAll$RepsTaxa)


optListBMAllCarniv <- traitHadley(repIntTaxa = PredrepIntAll$RepsTaxa,
                                  ...
                                  bigList = bigListPred, 
                                  intervals = intervals, 
                                  bmBreaks = c(-Inf, 0, 0.845098, 1.322219, 2, Inf), #need get these from Christiane and Mark, meeting 7/14/2021 Blaire wanted 200+ catagory
                                  extra.intvs = 0, 
                                  do.parallel=FALSE, 
                                  do.heuristic = FALSE,
                                  do.save = FALSE,
...
save(PredrepIntAll,optListBMAllCarniv,#optListBMAllextantreg, optListTaxAllPred,
     bm_quantsPred_allcarniv, bm_quantsPred_extantreg, 
     bigListPred, shortFamPred, intervals, 
     file = "C:/Users/Bark/Documents/PPP_Pred_Prey Code/R/AllCarniv100RepHadleyOutput_2021_7_16.Rdata")

optListBMAllextantreg <- traitHadley(repIntTaxa = PredrepIntAll$RepsTaxa,
                                     ...
                                     do.save = FALSE,
                                     run.update = 10)
save(PredrepIntAll,optListBMAllextantreg, #optListTaxAllPred,
     bm_quantsPred_allcarniv, bm_quantsPred_extantreg, 
     bigListPred, shortFamPred, intervals, 
     file = "C:/Users/Bark/Documents/PPP_Pred_Prey Code/R/ExtentReg100RepHadleyOutput_2021_7_16.Rdata")

optListTaxAllPred <-taxHadley(repIntTaxa = PredrepIntAll$RepsTaxa,
                          occs = occs,
                          reps = 100,
                          shortFam = shortFamPred,
                          bigList = bigListPred,
...
save(PredrepIntAll,optListBMAllCarniv,optListBMAllextantreg, optListTaxAllPred,
     bm_quantsPred_allcarniv, bm_quantsPred_extantreg, 
     bigListPred, shortFamPred, intervals, 
     file = "C:/Users/Bark/Documents/PPP_Pred_Prey Code/R/Carnivore100RepHadleyOutput_2021_7_15.Rdata")

load("C:/Users/Bark/Documents/PPP_Pred_Prey Code/R/CarnivoreHadleyOutput_2021_7_14.Rdata")

#plot out breaks
hadleyHisto(measure.mat = pred.data, 
            bmBreaks = c(-Inf, 0, 0.845098, 1.322219, 2, Inf),
            repIntTaxa = PredrepIntAll$RepsTaxa,
            optList_bm_median = optListBMAllCarniv$OptListTraitMedian,
            intervals = intervals)

plotNumberShiftPerRep(optList_tax_allReps = optListTaxAll$OptListTaxAllReps, 
                      optList_bm_allReps = optListBMAllCarniv$OptListTraitAllReps)
